...
function Heading3() {
  return (
    <div className="h-[126px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Inter:Bold',_sans-serif] font-bold leading-[63px] left-0 not-italic text-[#2212ab] text-[63px] text-nowrap top-px tracking-[0.2307px] whitespace-pre">Brand Hub</p>
      <Text />
    </div>
  );
}
...
function Button() {
  return (
    <div className="absolute bg-[#f96b09] h-[42px] left-0 rounded-[1.67772e+07px] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1),0px_8px_10px_-6px_rgba(0,0,0,0.1)] top-[281.31px] w-[192.953px]" data-name="Button">
...
function Heading4() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Inter:Medium',_sans-serif] font-medium leading-[21px] left-0 not-italic text-[#2212ab] text-[14px] text-nowrap top-0 tracking-[-0.1504px] whitespace-pre">Live Stats</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="h-[17.5px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',_sans-serif] font-normal leading-[17.5px] left-0 not-italic text-[#4a5565] text-[12.25px] text-nowrap top-[0.5px] tracking-[-0.0179px] whitespace-pre">{`See how your content performs in real-time. Know what's poppin'!`}</p>
    </div>
  );
}
...
function Heading5() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Inter:Medium',_sans-serif] font-medium leading-[21px] left-0 not-italic text-[#2212ab] text-[14px] text-nowrap top-0 tracking-[-0.1504px] whitespace-pre">Content Calendar</p>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="h-[17.5px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',_sans-serif] font-normal leading-[17.5px] left-0 not-italic text-[#4a5565] text-[12.25px] text-nowrap top-[0.5px] tracking-[-0.0179px] whitespace-pre">{`Plan posts, launches & collabs without the chaos`}</p>
    </div>
  );
}
...
function Heading6() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Inter:Medium',_sans-serif] font-medium leading-[21px] left-0 not-italic text-[#2212ab] text-[14px] text-nowrap top-0 tracking-[-0.1504px] whitespace-pre">On-The-Go Access</p>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="h-[17.5px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',_sans-serif] font-normal leading-[17.5px] left-0 not-italic text-[#4a5565] text-[12.25px] text-nowrap top-[0.5px] tracking-[-0.0179px] whitespace-pre">Manage your empire from anywhere—coffee shop, beach, wherever</p>
    </div>
  );
}
...
function App1() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[14px] h-[157.5px] items-start left-0 pb-0 pt-[14px] px-0 top-[351.31px] w-[497.5px]" data-name="App">
      <Container2 />
      <Container5 />
      <Container8 />
    </div>
...
function App2() {
  return <div className="absolute bg-[#f96b09] blur-3xl filter left-1/2 -translate-x-1/2 opacity-20 rounded-[1.67772e+07px] size-[500px] top-1/2 -translate-y-1/2" data-name="App" />;
}
...
function Container38() {
  return <div className="absolute bg-gradient-to-l from-[#ca3500] h-[12px] left-[-3px] rounded-br-[4.75px] rounded-tr-[4.75px] to-[#9f2d00] top-[120px] w-[3px]" data-name="Container" />;
}
...
function Container41() {
  return (
    <div className="absolute h-[826.305px] left-0 rounded-[60px] top-0 w-[393px]" data-name="Container">
      {/* Outer titanium frame with gradient */}
      <div className="absolute inset-0 rounded-[60px] bg-gradient-to-br from-gray-700 via-gray-800 to-gray-900 p-[3px]">
        <Container39 />
      </div>
      {/* Shadow layer */}
      <div className="absolute inset-0 rounded-[60px] shadow-[0px_20px_60px_-15px_rgba(0,0,0,0.5)] pointer-events-none" />
      {/* Subtle edge highlight for premium look */}
      <div className="absolute inset-0 rounded-[60px] bg-gradient-to-br from-white/10 via-transparent to-transparent pointer-events-none" />
    </div>
  );
}
...
function App3() {
  return (
    <div className="absolute h-[826.305px] left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 w-[393px]" data-name="App">
      <Container41 />
    </div>
  );
}
...
function Container43() {
  return (
    <div className="[grid-area:1_/_2] h-[854.305px] relative shrink-0 flex items-center justify-center" data-name="Container">
      <App2 />
      <App3 />
    </div>
  );
...
export default function Container44() {
  return (
    <div className="gap-[42px] grid grid-cols-[1fr_auto] grid-rows-[repeat(1,_minmax(0px,_1fr))] relative size-full items-center" data-name="Container">
      <Container9 />
      <Container43 />
    </div>
  );
